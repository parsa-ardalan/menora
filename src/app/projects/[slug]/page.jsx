...
export default async function Project({ params }) {
    ...
    return (
        ...
        <main
            dir="rtl"
            className="grid min-h-screen grid-cols-2 pt-32 px-10 lg:px-20 gap-20"
        >
            ...
            <div className="col-span-2 lg:col-span-1">
                ...
                <div className="px-5 lg:sticky lg:top-8 lg:px-10">
                    ...
                    <section className="mt-10">
                        ...
                        <div className="border-t border-gray-200">
                            ...
                            <h2 className="mt-3 text-xl font-bold leading-8 text-primary">
                                طراحی شده برای
